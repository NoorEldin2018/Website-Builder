...
export class EditTemplateComponent implements OnInit {
  ...
  constructor() {
    ...
    document.addEventListener("click", (e) => {
      let SelectedElements = Array.from(document.querySelectorAll(".isSelected"));
      ...
      if (e.toElement.nodeName == "P" || e.toElement.nodeName == "H1" || e.toElement.nodeName == "H2" || e.toElement.nodeName == "H3" || e.toElement.nodeName == "H4" || e.toElement.nodeName == "H5" || e.toElement.nodeName == "H6" || e.toElement.nodeName == "SPAN") {
        e.toElement.classList.add("isSelected");
        $("#editMenuStyle").css({ 'display': 'block', 'position': `fixed`, 'top': e.offsetY, 'left': e.offsetX })
  ...
  hideEditContainer() {
    let editMenu = document.getElementById("editMenuStyle");
    editMenu.style.display = "none";
  }
}
